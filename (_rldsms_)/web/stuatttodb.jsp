<%-- 
    Document   : stuatttodb
    Created on : 17 Jun, 2015, 1:04:57 PM
    Author     : siddhant
--%>
    ...
    <body>
        <%
            ...
            for(i=as;i<=al;i++)
            {
                ...
                d++;
                PreparedStatement ps=con.prepareStatement(" select * from stuatt where suserid=?");
                ps.setInt(1,i);
                
                ResultSet s2=ps.executeQuery();
                if(s2.next())
                {
                    String subs=s2.getString(""+subj+"");
                    int sp= Integer.parseInt(subs);
                    if(ab.equals("p")){
                    sp++;
                    }
                    else
                    ...
                    PreparedStatement ps1=con.prepareStatement("update stuatt set "+subj+"=? where suserid=?");
                    ps1.setInt(1, sp);
                    ps1.setInt(2, i);
